...
This is a plot that use the relative ration between 3 variables to plot a point in a scatter-plot like visualization. The three variables will be plotted according to their relative part between 0-100 relative to the sum of the 3 values, per row in the data set.
